...
public class Assignment1 {
    ...
    public static void main(String[] args) {
        ...
        final int DICE_IN_PLAY = 5; //change const to final
        int[] hand = new int[DICE_IN_PLAY];
        char playAgain = 'y';
        Scanner keyboard = new Scanner(System.in); //create to read in input
        ...
        while(playAgain == 'y')
        {
            ...
            while(turn < 4 && keep != "yyyyy")
            {
                ...
                {
                    if(keep.charAt(dieNumber) != 'y') //access char within string
    ...
    //This function simulates the rolling of a single di
    ...
    //This function returns the count of the die value occuring most in the hand
    ...
    //this function returns the length of the longest stright found in a hand
